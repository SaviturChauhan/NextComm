...
import { FiMessageSquare, FiClock, FiEye, FiTag } from 'react-icons/fi';
...
const UnansweredQuestions = () => {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const response = await apiClient.get('/api/unanswered/unanswered', { params });
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Questions waiting for their first answer
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Great! All questions have at least one answer.
              </p>
            </div>
          ) : (
            <>
