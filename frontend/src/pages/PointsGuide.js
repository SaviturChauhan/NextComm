...
const PointsGuide = () => {
  const earningActions = [
    {
      ...
      reputation: "+1",
      description:
        "Earn points by asking well-formatted questions that help the community.",
      color:
    ...
    },
    {
      ...
      reputation: "+2",
      description:
        "Provide helpful answers to questions. More points than asking!",
      color:
    ...
    },
    {
      ...
      reputation: "+3",
      description:
        "Get more points when your answer receives an upvote (higher value than question upvotes).",
      color:
    ...
    },
    {
      ...
      reputation: "+50",
      description:
        "Huge reward when the question author accepts your answer as the best solution!",
      color:
  ...
  const badges = [
    ...
    },
    {
      ...
      iconBg:
        "bg-gradient-to-br from-orange-100 to-red-100 dark:from-orange-800/50 dark:to-red-800/50",
    ...
    },
    {
      ...
      iconBg:
        "bg-gradient-to-br from-yellow-100 via-amber-100 to-orange-100 dark:from-yellow-800/50 dark:via-amber-800/50 dark:to-orange-800/50",
    ...
    },
    {
      ...
      bgColor:
        "bg-gradient-to-br from-pink-50 via-rose-50 to-red-50 dark:from-pink-900/30 dark:via-rose-900/30 dark:to-red-900/30",
      borderColor: "border-pink-400 dark:border-pink-600",
      textColor: "text-pink-700 dark:text-pink-300",
      iconBg:
        "bg-gradient-to-br from-pink-100 via-rose-100 to-red-100 dark:from-pink-800/50 dark:via-rose-800/50 dark:to-red-800/50",
    ...
    },
    {
      ...
      bgColor:
        "bg-gradient-to-br from-purple-50 via-fuchsia-50 to-pink-50 dark:from-purple-900/30 dark:via-fuchsia-900/30 dark:to-pink-900/30",
      borderColor: "border-purple-500 dark:border-purple-600",
      textColor: "text-purple-800 dark:text-purple-200",
      iconBg:
        "bg-gradient-to-br from-purple-100 via-fuchsia-100 to-pink-100 dark:from-purple-800/60 dark:via-fuchsia-800/60 dark:to-pink-800/60",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-primary to-blue-600 rounded-2xl p-8 mb-12 text-white shadow-lg">
            ...
            <p className="text-lg mb-4">
              Points reflect your overall contribution to the community. Your
              reputation score determines your standing and unlocks special
              privileges as you progress.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                <div className="text-3xl font-bold mb-1">Points</div>
                <div className="text-sm opacity-90">
                  Your total score from all activities
                </div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 text-center">
              Earn prestigious badges as you progress! Each badge gets more
              impressive as you climb the ranks.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              {badges.map((badge, index) => (
                <div
                  key={index}
                  className={`relative ${badge.bgColor} ${badge.borderColor} ${
                    badge.shadow
                  } ${badge.ring || ""} 
                    border-2 rounded-2xl p-6 transition-all duration-300 hover:scale-[1.02] ${
                      badge.animate || ""
                    }
                ...
                >
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    <div
                      className={`${badge.iconBg} p-4 rounded-xl ${badge.shadow} relative flex-shrink-0`}
                    >
                      <div
                    ...
                    <div className="flex-1 min-w-0">
                      {/* Badge Name */}
                      <h3
                        className={`text-2xl font-extrabold ${badge.textColor} mb-2 flex items-center gap-2`}
                      >
                        {badge.name}
                        {index >= 5 && (
                      ...
                      <div className="mb-3">
                        <span
                          className={`inline-block px-4 py-1.5 bg-gradient-to-r ${badge.color} text-white rounded-full text-sm font-bold shadow-md`}
                        >
                          {badge.points}+ points
                        </span>
                      </div>
                  ...
                  {badge.glow && (
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${badge.color} opacity-5 rounded-2xl pointer-events-none`}
                    ></div>
                  )}
                </div>
              ))}
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-800 rounded-xl p-8 mb-12">
            ...
            <ul className="space-y-3 text-gray-700 dark:text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong>Quality over quantity:</strong> Well-researched,
                  detailed answers earn more upvotes and acceptance.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-1">•</span>
                <span>
                  <strong>Answer early:</strong> Be one of the first to provide
                  a helpful answer to trending questions.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-1">•</span>
                <span>
                  <strong>Format properly:</strong> Use code blocks, images, and
                  clear explanations to make your content stand out.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-1">•</span>
                <span>
                  <strong>Be respectful:</strong> Constructive, helpful
                  contributions get more engagement than negative ones.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-blue-500 font-bold mt-1">•</span>
                <span>
                  <strong>Stay active:</strong> Regular participation builds
                  reputation and increases visibility.
                </span>
              </li>
            </ul>
          </div>
