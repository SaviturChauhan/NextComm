          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                Tip: Use LaTeX syntax. Common examples: <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">{"\\frac{a}{b}"}</code>, <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">{"\\sum_{i=1}^{n}"}</code>, <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">{"\\int_{0}^{\\infty}"}</code>
              </p>
            </div>
